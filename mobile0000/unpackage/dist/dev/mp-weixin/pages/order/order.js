...
/***/ 72:
/*!*****************************************************************************************************!*\
  !*** /Users/Wang/Documents/kh0706/kh_community/mobile0000/main.js?{"page":"pages%2Forder%2Forder"} ***!
  \*****************************************************************************************************/
...
/***/ 73:
/*!**********************************************************************************!*\
  !*** /Users/Wang/Documents/kh0706/kh_community/mobile0000/pages/order/order.vue ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ 74:
/*!*****************************************************************************************************************!*\
  !*** /Users/Wang/Documents/kh0706/kh_community/mobile0000/pages/order/order.vue?vue&type=template&id=127632e4& ***!
  \*****************************************************************************************************************/
...
/***/ 75:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/Wang/Documents/kh0706/kh_community/mobile0000/pages/order/order.vue?vue&type=template&id=127632e4& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 76:
/*!***********************************************************************************************************!*\
  !*** /Users/Wang/Documents/kh0706/kh_community/mobile0000/pages/order/order.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 77:
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/Wang/Documents/kh0706/kh_community/mobile0000/pages/order/order.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  methods: {
    ...
    //按标签获取分类列表
    loadData: function loadData(source) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var index, navItem, flags, orders, order_info;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                //获取所有的订单列表
                _context.next = 10;return _this.getOrders();case 10:orders = _context.sent;
                console.log(orders);
                order_info = orders;

                setTimeout(function () {
                  console.log(order_info);
                  var orderList = order_info.filter(function (item) {
                    //添加不同状态下订单的表现形式
                    item = Object.assign(item, _this.orderflagsExp(item.info.flags));
                    //演示数据所以自己进行状态筛选
                    if (flags === 8) {
                      //8为全部订单
                      return item;
    ...
    cancelOrder: function cancelOrder(item) {var _this2 = this;
      return new Promise(function (resolve) {
        uni.request({
          ...
          url: _this2.api.ApiRoot + "orders/" + item.info.id + "/",
          data: {
    ...
    refund: function refund(item) {
      uni.navigateTo({
        url: "/pages/money/refund?&data=".concat(encodeURIComponent(JSON.stringify(item))) });


    },

    //确认收货
    comfirm: function comfirm(item) {var _this4 = this;
      return new Promise(function (resolve) {
        uni.request({
          header: {
            "content-type": "application/json" },

          url: _this4.api.ApiRoot + "orders/" + item.info.id + "/",
          data: {
            "id": item.info.id,
            "updated_at": item.info.updated_at,
            "created_at": item.info.created_at,
    ...
    //从服务器请求Order的信息
    getOrders: function getOrders() {var _this5 = this;
      return new Promise(function (resolve) {
        uni.request({
          header: {
            "content-type": "application/x-www-form-urlencoded" },

          url: _this5.api.ApiRoot + "orders/queryByUser/?user_id=" + uni.getStorageSync('userDetail').id,
    ...
    getOrderDetails: function getOrderDetails(order_id) {var _this6 = this;
      return new Promise(function (resolve) {
        uni.request({
          header: {
            "content-type": "application/x-www-form-urlencoded" },

          url: _this6.api.ApiRoot + "orders/" + order_id + "/details/",
    ...
    //订单状态文字和颜色
    orderflagsExp: function orderflagsExp(flags) {
      var flagsTip = '',
    ...
    navToDetailPage: function navToDetailPage(item) {
      ...
      var msg = item;
      uni.navigateTo({
        url: "/pages/order/orderDetail?data=".concat(encodeURIComponent(JSON.stringify(msg))) });


    },

    //导航至物流页面
    navToLogisticPage: function navToLogisticPage(item) {
      //测试数据没有写id，用title代替
      var msg = item;
      uni.navigateTo({
        url: "/pages/order/orderLogistic?data=".concat(encodeURIComponent(JSON.stringify(msg))) });
    ...
    payOrder: function payOrder(item) {
      ...
      var serial = item.info.serial_number;
    ...
    //导航至退款界面
    refundrequest: function refundrequest(item) {
      var msg = item;
      uni.navigateTo({
        url: "/pages/money/refund?data=".concat(encodeURIComponent(JSON.stringify(msg))) });
...
/***/ 78:
/*!********************************************************************************************************************!*\
  !*** /Users/Wang/Documents/kh0706/kh_community/mobile0000/pages/order/order.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 79:
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/Wang/Documents/kh0706/kh_community/mobile0000/pages/order/order.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
