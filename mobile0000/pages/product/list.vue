...
<script>
	...
	export default {
		...
		onLoad(options){
			...
			this.fidServer = options.fid;
			this.sidServer = options.sid;
		...
		methods: {
			...
			async loadCateList(fid, sid){
				let that = this
				that.util.request(that.api.CategoryList).then(function(res) {
					let list = res.data.category_list;
			...
			async loadData(type='add', loading) {
				...
				let that = this
				that.util.request(that.api.GoodsList, {fid:this.fidServer, sid:this.sidServer, tid:this.cateId}).then(function(res) {
